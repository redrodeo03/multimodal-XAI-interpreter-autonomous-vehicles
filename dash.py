...
class AirSimDashboard:
    ...
    def update_gemini_text(self):
        def gemini_thread():
            while True:
                try:
                    current_value = car_data
                    system_prompt = "You are a AI driving assistant. You are avoiding hitting a parked car by turning 10 degrees. You are being provided car telemetry data. Explain why you autonomously performed this action by using this information. Do this to gain trust of the user sitting in the car. Keep it very concise."
